...
.PHONY: help connect_to_repo release pre_commit venv local_install test_install local_dev_install tests-unit mock-tests-unit tests-integration build local_build clean_venv local_clean_windows local_clean_linux docker_build docs_install new_env_conda
